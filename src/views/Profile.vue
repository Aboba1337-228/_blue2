            ...
            <div class="profile__inner">
                <div class="profile__data">
                    ...
                    <div class="data__user">
                        <h3>Номер школы: {{ username }}</h3>
                        <h3>Класс: {{ email }}</h3>
                        <h3>По списку: {{ phone }}</h3>
                    </div>
                    <div class="data__user">
                        <h3>Муниципалитет: {{ city }}</h3>
                        <h3>Образовательное учереждение: {{ schools }}</h3>
                    </div>
        ...
        async Auth() {
            ...
            if(token == null) {} else {
                try {
                    ...
                    this.username = infoUser.data.user.numSchools
                    this.email = infoUser.data.user.numClass
                    this.phone = infoUser.data.user.numSip
                    this.city = infoUser.data.user.city
                    this.schools = infoUser.data.user.schools
                    this._success = true
                } catch (error) {
